...
> This roadmap records an earlier prototype plan and is not the current implementation queue.  
> Use [`../IMPLEMENTATION_PLAN.md`](../IMPLEMENTATION_PLAN.md) for current priorities and dependency order.

This roadmap describes the direction used during Cherry's initial OSS migration and prototype stabilization. It is preserved for historical context.
