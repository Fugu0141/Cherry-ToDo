(() => {
  ...
  const defaultScriptOrder = [
    ...
    ["task-delete-context-action-registration", "task-delete-context-action-registration.js"],
    ["auto-layout-board-tool-registration", "auto-layout-board-tool-registration.js"],
    ["flow-popovers", "release-flow-popovers.js"],
    ["tutorial", "tutorial.js"],
    ["tutorial-extension-registration", "tutorial-extension-registration.js"],
    ["storage-session-bridge", "storage-session-bridge.js"],
    ["tabs", "tab-manager.js"],
    ["workspace-transfer-extension-registration", "workspace-transfer-extension-registration.js"],
